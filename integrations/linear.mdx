...
section and click **Connect** in the **Linear** row.

<Frame>
  <img src="/assets/screenshots/integrations/linear/organization-profile-settings.png" />
</Frame>
<br />

<Info>
  The Linear integration connects via your Linear account, not your team's
  Linear organization, so you won't need an admin to use it.
</Info>
...
<AccordionGroup>
  <Accordion title="What happens when someone resolves a comment attached to a Linear issue?">
    When someone resolves a comment attached to a Linear issue, the issue will
    be marked **Done** in Linear.
  </Accordion>
</AccordionGroup>
